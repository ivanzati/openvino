---
sidebar_label: 'OpenVINO GenAI on NPU'
format: md
---
...
\[See the installation guide\](../../get-started/install-openvino/install-openvino-genai.md)
...
There are pre-compressed models on Hugging Face that can be exported as-is, for example:
  ...
  - [LLMs optimized for NPU](https://huggingface.co/collections/OpenVINO/llms-optimized-for-npu-686e7f0bf7bc184bd71f8ba0), hosted and maintained by OpenVINO.
...
However, these parameters must be provided in a slightly different way. They should be placed in \{"DEVICE\_PROPERTIES": \{"NPU" : ... \} \} section of config:
...
[whisper-small](https://huggingface.co/openai/whisper-small), or
[whisper-large](https://huggingface.co/openai/whisper-large) models) was first introduced in
...
[32.0.100.3104 or newer](https://www.intel.com/content/www/us/en/download/794734/intel-npu-driver-windows.html).
...
## Additional Resources
  ...
  - \[NPU Device\](../../openvino-workflow/running-inference/inference-devices-and-modes/npu-device.md)
