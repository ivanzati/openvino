---
sidebar_label: 'OpenVINO Security'
format: md
---
...
\[Security Add-on\](../about-openvino/openvino-ecosystem/openvino-project/openvino-security-add-on.md). You can find its description
...
![image](img/deploy_encrypted_model.svg)
...
docs/articles\_en/assets/snippets/protecting\_model\_guide.cpp
...
the [Intel Software Guard Extensions](https://software.intel.com/en-us/sgx).

Use the [ov::Core::read\_model](../api/c_cpp_api/group__ov__dev__exec__model.html#classov_1_1_core_1ae0576a95f841c3a6f5e46e4802716981)
...
[ov::Core::import\_model](../api/c_cpp_api/group__ov__runtime__cpp__api.html#_CPPv4N2ov4Core12import_modelERNSt7istreamERKNSt6stringERK6AnyMap)
...
## Additional Resources
  ...
  - For more information on Sample Applications, see the \[OpenVINO Samples Overview\](../get-started/learn-openvino/openvino-samples.md)
