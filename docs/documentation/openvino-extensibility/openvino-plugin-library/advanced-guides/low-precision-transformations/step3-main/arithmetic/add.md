---
sidebar_label: 'AddTransformation transformation'
format: md
---

# AddTransformation transformation

ov::pass::low\_precision::AddTransformation class represents the Add operation transformation.
