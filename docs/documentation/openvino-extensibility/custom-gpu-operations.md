---
sidebar_label: 'How to Implement Custom GPU Operations'
format: md
---
...
docs/articles\_en/assets/snippets/gpu/custom\_kernels\_api.py

C++

docs/articles\_en/assets/snippets/gpu/custom\_kernels\_api.cpp
...
See the [Debugging Tips](#debugging-tips) below for information on debugging the results.
...
## Additional Resources
  ...
  - Models in the OpenVINO IR format published on [Hugging Face](https://huggingface.co/OpenVINO).
