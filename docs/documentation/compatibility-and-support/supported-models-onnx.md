---
sidebar_label: 'AI Models verified for OpenVINO™ - ONNX only'
format: md
---
...
Marked cells indicate models that passed inference with no errors. Empty cells indicate models that were not tested. No failing runs producing an error have been recorded.  
