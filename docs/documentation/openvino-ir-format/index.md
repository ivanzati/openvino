---
sidebar_label: 'OpenVINO IR format'
format: md
---
...
\[supported formats\](../openvino-workflow/model-preparation.md)
...
\[See why converting to OpenVINO IR is recommended\](../openvino-workflow/model-preparation/convert-model-to-ir.md)
...
## Additional Resources
  ...
  - \[IR and Operation Sets\](openvino-ir-format/operation-sets.md)
