---
sidebar_label: 'Low Precision IR (INT8 Inference)'
format: md
---
...
For more details, refer to the \[Model Optimization Guide\](../../openvino-workflow/model-optimization.md).
...
For more details, see the \[specification of FakeQuantize operation\](operation-sets/operation-specs/quantization/fake-quantize-1.md).

To execute the `Convolution` operation in INT8 on CPU, both data and weight inputs should have `FakeQuantize` as an input operation:

![image](img/expanded_int8_Convolution_weights.png)
...
![image](img/compressed_int8_Convolution_weights.png)
