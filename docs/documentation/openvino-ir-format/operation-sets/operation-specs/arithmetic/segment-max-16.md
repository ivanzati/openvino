...
For example `segments_ids` with value `[0,0,0,1,1,3,5,5]` defines 4 non-empty segments. `num_segments` is not given. When coupled with a 1D data tensor `data`, the segments are as follows:
  ...
  - Segment\_0: `[data[0], data[1], data[2]]`
  - Segment\_1: `[data[3], data[4]]`
  - Segment\_2: `[]`
  - Segment\_3: `[data[5]]`
  - Segment\_4: `[]`
  - Segment\_5: `[data[6], data[7]]`
...
**Types**
  ...
  - *T\_IDX1*, *T\_IDX2*: `int64` or `int32`.

**Examples**

*Example 1: num\_segments \< max(segment\_ids) + 1*
...
*Example 2: num\_segments > max(segment\_ids) + 1*
...
*Example 3: 2D input data, no num\_segments*
