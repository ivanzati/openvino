...
**Inputs**
  ...
  - **2**: Axis index along which the cumulative sum is performed. A scalar of type *T\_AXIS*. Negative value means counting dimensions from the back. Default value is `0`. **Optional.**
