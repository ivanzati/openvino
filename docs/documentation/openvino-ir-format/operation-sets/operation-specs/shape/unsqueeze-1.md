...
**Inputs**:
  ...
  - **2**: Scalar or 1D tensor of type *T\_INT* with indices of dimensions to unsqueeze. Values could be negative (have to be from range `[-R, R-1]`, where `R` is the rank of the output). **Required.**
