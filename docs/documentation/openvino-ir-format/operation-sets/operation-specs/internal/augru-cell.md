...
\[GRUCell\](../sequence/gru-cell-3.md) is the additional attention score
...
**Attributes**
  ...
  - *linear\_before\_reset*
      - **Description**: *linear\_before\_reset* flag denotes, if the output of hidden gate
...
**Inputs**
  ...
  - **5**: `B` - 2D tensor of type *T*. The biases. If *linear\_before\_reset* is set
