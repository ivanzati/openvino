---
sidebar_label: 'ExperimentalDetectronTopKROIs'
format: md
---
...
**Detailed description**: The operation performs probabilities descending sorting for input ROIs and returns *max\_rois*
number of ROIs. Order of sorted ROIs with equal probabilities is undefined. If the number of ROIs is less than *max\_rois*
...
**Attributes**:
  ...
  - *max\_rois*
      - **Description**: The *max\_rois* attribute specifies maximal numbers of output ROIs.
...
**Outputs**
  ...
  - **1**: A 2D tensor of type *T* with shape `[max_rois, 4]` describing *max\_rois* ROIs with highest probabilities.
