...
**Outputs**:
  ...
  - **1**: `selected_indices` - tensor of type *output\_type* and shape `[number of selected boxes, 3]` containing information about selected boxes as triplets `[batch_index, class_index, box_index]`.
  ...
  - **3**: `valid_outputs` - 1D tensor with 1 element of type *output\_type* representing the total number of selected boxes.
