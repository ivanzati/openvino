...
**Outputs**:
  ...
  - **1**: tensor with indices of non-zero elements of shape `[rank(data), num_non_zero]` of type *T\_OUT*.

**Types**

  - *T*: any type.
  - *T\_OUT*: Depending on *output\_type* attribute can be `int64` or `int32`.
