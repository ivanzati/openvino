...
**Short description**: *Convert* operation performs element-wise conversion on a given input tensor to a type specified in the *destination\_type* attribute.
...
**Outputs**
  ...
  - **1**: The result of element-wise *Convert* operation. A tensor of *destination\_type* type and the same shape as input tensor.
