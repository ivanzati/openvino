...
**Inputs**
  ...
  - **2**: A tensor of type *T\_BOOL* and arbitrary shape. **Required.**

**Outputs**

  - **1**: The result of element-wise *LogicalAnd* operation. A tensor of type *T\_BOOL* and the same shape equal to broadcasted shape of two inputs.
