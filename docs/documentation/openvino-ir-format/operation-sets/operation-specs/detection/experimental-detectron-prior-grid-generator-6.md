---
sidebar_label: 'ExperimentalDetectronPriorGridGenerator'
format: md
---
...
Numbers of generated cells is `featmap_height` and `featmap_width` if *h* and *w* are zeroes; otherwise, *h* and *w*, respectively. Steps of generated grid are `image_height` / `layer_height` and `image_width` / `layer_width` if *stride\_h* and *stride\_w* are zeroes; otherwise, *stride\_h* and *stride\_w*, respectively.
...
**Attributes**:
  ...
  - *w*
      ...
      - **Required**: *no*
  - *stride\_x*
      - **Description**: The *stride\_x* attribute specifies the step of generated grid with respect to x coordinate.
      - **Range of values**: non-negative float number
      - **Type**: `float`
      - **Default value**: 0.0
      - **Required**: *no*
  - *stride\_y*
      - **Description**: The *stride\_y* attribute specifies the step of generated grid with respect to y coordinate.
      - **Range of values**: non-negative float number
      - **Type**: `float`
      - **Default value**: 0.0
      - **Required**: *no*
