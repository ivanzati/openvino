...
[GRUCell](https://github.com/onnx/onnx/blob/main/docs/Operators.md#gru)
...
**Inputs**
  ...
  - **6**: `B` - 2D tensor of type *T*. If *linear\_before\_reset* is set to 1, then the shape
