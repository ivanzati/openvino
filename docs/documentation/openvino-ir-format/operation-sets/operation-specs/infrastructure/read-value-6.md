...
> to return the value of variable\_id.
...
\[StateAPI\](../../../../../../openvino-workflow/running-inference/inference-request/stateful-models.md) documentation page.
...
**Outputs**
  ...
  - **1**: tensor with the same shape and type as specified in *variable\_type*, *variable\_shape*.
