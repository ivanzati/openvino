---
sidebar_label: 'GroupConvolutionBackpropData'
format: md
---
...
is derived from the kernel shape.
  ...
  - *strides*
      ...
      - **Required**: *yes*
  - *pads\_begin*
      - **Description**: *pads\_begin* has the same definition as *pads\_begin* for a regular Convolution but applied in
  ...
  - *pads\_end*
      - **Description**: *pads\_end* has the same definition as *pads\_end* for a regular Convolution but applied
  ...
  - *dilations*
      ...
      - **Required**: *yes*
  - *auto\_pad*
      - **Description**: *auto\_pad* has the same definition as *auto\_pad* for a regular Convolution but applied
        in the backward way, for the output tensor.
  ...
  - *output\_padding*
      - **Description**: *output\_padding* adds additional amount of paddings per each spatial axis in the output tensor.
        It unlocks more elements in the output allowing them to be computed. Elements are added at the higher coordinate
        indices for the spatial dimensions. Number of elements in *output\_padding* list matches the number of spatial
