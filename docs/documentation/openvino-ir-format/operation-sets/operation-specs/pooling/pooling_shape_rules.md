---
sidebar_label: 'Shape Calculation Rules for Pooling Operators'
format: md
---
...
If `rounding_type` is set to `ceil_torch`, the last pooling operation within a dimension cannot start in the padding area. If this is the case, the respective dimension is reduced by `1`. More context can be found in the [PyTorch issue discussion](https://github.com/pytorch/pytorch/issues/57178).
