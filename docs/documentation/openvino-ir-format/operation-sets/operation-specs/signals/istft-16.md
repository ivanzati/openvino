---
sidebar_label: 'Inverse Short Time Fourier Transformation (ISTFT)'
format: md
---
...
**Inputs**
  ...
  - **3**: `frame_size` - Scalar tensor of type *T\_INT* describing the size of a single frame of the signal to be provided as input to FFT. **Required.**
  - **4**: `frame_step` - Scalar tensor of type *T\_INT* describing the distance (number of samples) between successive frames. **Required.**
  - **5**: `signal_length` - Scalar or single element 1D tensor of type *T\_INT* describing the desired length of the output signal, if not provided it's calculated accordingly to the rules presented in the detailed description above. **Optional.**
...
**Types**
  ...
  - *T\_INT*: `int64` or `int32`.

**Examples**:

*Example 3D input, 1D output signal, center=false, default signal\_length:*
...
*Example 4D input, 2D output signal, center=false, default signal\_length:*
...
*Example 3D input, 1D output signal, center=true, default signal\_length:*
...
*Example 4D input, 2D output signal, center=true, default signal\_length:*
...
*Example 3D input, 1D output signal, center=false, signal\_length input provided:*
