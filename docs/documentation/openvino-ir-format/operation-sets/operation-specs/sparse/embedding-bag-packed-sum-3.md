---
sidebar_label: 'EmbeddingBagPackedSum'
format: md
---
...
Operation is equivalent to *ReduceSum(Multiply(Gather(emb\_table, indices, axis=0), Unsqueeze(per\_sample\_weights, -1)), axis=1)*.
