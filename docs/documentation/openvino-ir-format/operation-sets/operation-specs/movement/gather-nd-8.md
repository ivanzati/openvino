...
**Attributes**:
  ...
  - *batch\_dims*
      - **Description**: *batch\_dims* (denoted as `b`) is a leading number of dimensions of `data` tensor and `indices`
...
**Inputs**:
  ...
  - **2**: `indices` tensor of type *T\_IND*. A tensor of a rank not less than 1.
