...
**Inputs**:
  ...
  - **3**: `start` - 1D tensor of type *T\_IND*.
  ...
  - **4**: `stop` - 1D tensor of type *T\_IND*.
  ...
  - **5**: `step` - 1D tensor of type *T\_IND*.
  ...
  - **6**: `axes` - 1D tensor of type *T\_AXIS*.
