---
sidebar_label: 'ScatterElementsUpdate'
format: md
---
...
Additionally, *use\_init\_val* attribute can be used to control whether the elements from the `data` input tensor are used as initial value (enabled by default).
...
**Types**
  ...
  - *T\_IND*: any integer numeric type.
  - *T\_AXIS*: any integer numeric type.
