---
sidebar_label: 'Converting a JAX/Flax Model (Experimental)'
format: md
---
...
1.  Refer to the [JAX and TensorFlow interoperation](https://github.com/google/jax/blob/main/jax/experimental/jax2tf/README.md)
    guide to learn how to export models from JAX/Flax to TensorFlow SavedModel format.
2.  Follow \[Convert a TensorFlow model\](convert-model-tensorflow.md) chapter to produce an OpenVINO IR model.
