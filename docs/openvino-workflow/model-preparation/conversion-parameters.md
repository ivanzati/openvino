---
sidebar_label: 'Conversion Parameters'
format: md
---
...
frameworks. Use \[Supported Model Formats\](../model-preparation.md) page for more
dedicated framework-dependent tutorials.

You can obtain a model from [Hugging Face](https://huggingface.co/models). When you
...
which are described below.
  ...
  - `example_input` parameter available in Python `openvino.convert_model` only is
    ...
    For more details, refer to the \[PyTorch Model Conversion\](convert-model-pytorch.md),
    \[TensorFlow Model Conversion\](convert-model-tensorflow.md), or \[JAX/Flax Model Conversion\](convert-model-jax.md).
  - `input` parameter to set or override shapes for model inputs. It configures dynamic
    ...
    information on this parameter, refer to the \[Setting Input Shapes\](setting-input-shapes.md)
    guide.
...
\[Inference Devices and Modes\](../running-inference/inference-devices-and-modes.md).

Note

`FP16` compression is sometimes used as the initial step for `INT8` quantization.
Refer to the \[Post-training optimization\](../model-optimization-guide/quantizing-models-post-training.md) guide for more
information about that.
  ...
  - `extension` parameter which makes possible conversion of the models consisting of
    ...
    \[Frontend Extensions\](../../documentation/openvino-extensibility/frontend-extensions.md)
    guide.
