---
sidebar_label: 'Converting a PyTorch Model'
format: md
---
...
You can download a PyTorch model from [PyTorch Hub](https://pytorch.org/hub/) or
...
Check out more examples in \[interactive Python tutorials\](../../get-started/learn-openvino/interactive-tutorials-python.md).
...
Check out more examples of model conversion with non-tensor data types in the following tutorials:
  ...
  - [Video Subtitle Generation using Whisper and OpenVINO™](https://github.com/openvinotoolkit/openvino_notebooks/tree/latest/notebooks/whisper-subtitles-generation)
  - [Visual Question Answering and Image Captioning using BLIP and OpenVINO](https://github.com/openvinotoolkit/openvino_notebooks/tree/latest/notebooks/blip-visual-language-processing)
...
[torch.export](https://pytorch.org/docs/stable/export.html) is the current way to get a graph
...
representation, refer to [PyTorch documentation](https://pytorch.org/docs/stable/fx.html).
...
[torch.export.save()](https://pytorch.org/docs/stable/export.html#serialization).
...
[torch.jit.save()](https://pytorch.org/docs/stable/generated/torch.jit.save.html) serializes
...
1.  Refer to the [Exporting PyTorch models to ONNX format](https://pytorch.org/docs/stable/onnx.html)
    guide to learn how to export models from PyTorch to ONNX.
2.  Follow the \[Convert an ONNX model\](convert-model-onnx.md) guide to produce OpenVINO IR.
...
[Operator Schemas](https://github.com/onnx/onnx/blob/master/docs/Operators.md) page.
