...
[tokenizers and detokenizers](https://github.com/openvinotoolkit/openvino_tokenizers/tree/master).
...
[GenAI Samples](https://github.com/openvinotoolkit/openvino.genai/tree/master/samples/cpp/text_generation).
...
## Additional Resources
  ...
  - Learn about the \[basic steps to integrate inference in your application\](../../running-inference.md).
  - Use [OpenVINO tokenizers](https://github.com/openvinotoolkit/openvino_contrib/tree/releases/2024/0/modules/custom_operations/user_ie_extensions/tokenizer/python) to produce models that use string tensors to work with textual information as pre- and post-processing for the large language models.
  - Check out [GenAI Samples](https://github.com/openvinotoolkit/openvino.genai/tree/master/samples/cpp/text_generation) to see how string tensors are used in real-life applications.
