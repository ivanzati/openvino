---
sidebar_label: 'NPU Plugin Batching'
format: md
---
...
**If the conditions are met**, the NPU plugin attempts to compile and execute the original model with batch\_size forced to 1. This approach is due to current compiler limitations and ongoing work to improve performance for batch\_size greater than one.
...
batch\_size to N as any other regular model.
