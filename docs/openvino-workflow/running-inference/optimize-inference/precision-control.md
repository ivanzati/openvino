---
sidebar_label: 'Precision Control'
format: md
---
...
may lower the accuracy for performance reasons (**PERFORMANCE mode**)
  ...
  - In **ACCURACY mode**, the device does not convert floating-point tensors to a smaller
    ...
    Additionally, *Dynamic Quantization* is disabled in this mode.
...
\[OpenVINO optimization tools\](../../model-optimization-guide/quantizing-models-post-training.md)
...
docs/articles\_en/assets/snippets/ov\_execution\_mode.py

C++

docs/articles\_en/assets/snippets/ov\_execution\_mode.cpp
...
Activation scaling uses \[LPT (Low Precision Transformations)\](../../../documentation/openvino-extensibility/openvino-plugin-library/advanced-guides/low-precision-transformations.md) to delay multiplication by the scale factor as much as possible, preventing overflow.
