---
sidebar_label: 'Troubleshooting Guide for OpenVINO™ Installation & Configuration'
format: md
---
...
[Support for OpenVINO™ toolkit](https://www.intel.com/content/www/us/en/support/products/96066/software/development-software/openvino-toolkit.html)
...
Windows case, installing [Microsoft Visual C++ Redistributable \[vc\_redist.x64\]](https://aka.ms/vs/17/release/vc_redist.x64.exe)
package may fix it. For more information on dependencies, check
\[System Requirements\](../../../about-openvino/release-notes-openvino/system-requirements.md) and
\[Additional Hardware Configurations and Troubleshooting\](../configurations.md)
...
settings for it. See the [Docker guide](https://docs.docker.com/network/proxy/#set-proxy-using-the-cli)
for more details.
...
requirements, you need to upgrade:
  ...
  - For Linux and macOS systems, download and install a proper Python version from the
    [official website](https://www.python.org/). See the
...
Check if environment variables are set correctly
  ...
  - If you don't see the information above, your PATH variables may be configured incorrectly.
    Check if you have typed the correct \<INSTALL\_DIR> or you are trying to activate in the
    correct directory.
...
\[Additional configurations\](../configurations.md) may be
...
as described in \[additional configurations for GPU\](./configurations-intel-gpu.md).
