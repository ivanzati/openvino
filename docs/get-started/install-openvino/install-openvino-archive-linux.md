---
sidebar_label: 'Install OpenVINO™ Runtime on Linux from an Archive File'
format: md
---
...
4.  Download the [OpenVINO Runtime archive file for your system](https://storage.openvinotoolkit.org/repositories/openvino/packages/2026.0/linux/),
...
If your \<INSTALL\_DIR> is not `/opt/intel/openvino_2026`, use the correct one instead.
...
## Additional Resources
  ...
  - \[Troubleshooting Guide for OpenVINO Installation & Configuration\](./configurations/troubleshooting-install-config.md)
  - Converting models for use with OpenVINO™: \[Convert a Model\](../../../openvino-workflow/model-preparation.md)
  - Writing your own OpenVINO™ applications: \[OpenVINO™ Runtime User Guide\](../../../openvino-workflow/running-inference.md)
