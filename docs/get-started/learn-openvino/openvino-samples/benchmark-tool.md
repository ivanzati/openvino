...
\[AUTO plugin\](../../../openvino-workflow/running-inference/inference-devices-and-modes/auto-device-selection.md).
...
using \[PyPI\](../../../get-started/install-openvino/install-openvino-pip.md).
...
Make sure to \[convert your models\](../../../openvino-workflow/model-preparation/convert-model-to-ir.md)
if necessary.
...
*Build the Sample Applications* instructions and
then set up paths and environment variables by following the
\[Get Ready for Running the Sample Applications\](../openvino-samples.md)
...
\[Benchmark Python Tool\](benchmark-tool.md) is available,
...
OpenVINO also allows you to \[convert your models\](../../../openvino-workflow/model-preparation/convert-model-to-ir.md).
...
is given in the *Advanced Usage* section.
...
\[High-level Performance Hints\](../../../openvino-workflow/running-inference/optimize-inference/high-level-performance-hints.md) page.
For more details on optimal runtime configurations and how they are automatically
determined using performance hints, see
\[Runtime Inference Optimizations\](../../../openvino-workflow/running-inference/optimize-inference.md).
...
\[Automatic device selection\](../../../openvino-workflow/running-inference/inference-devices-and-modes/auto-device-selection.md) page.
...
see the *Examples of Running the Tool* section.
...
`-data_shape` argument descriptions in the *All configuration options*
