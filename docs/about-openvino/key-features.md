...
\[Support for multiple frameworks\](../openvino-workflow/model-preparation/convert-model-to-ir.md)  
...
\[Close integration with PyTorch\](../openvino-workflow/torch-compile.md)  
    For PyTorch-based applications, specify OpenVINO as a backend using \[torch.compile\](../openvino-workflow/torch-compile.md) to improve model inference. Apply OpenVINO optimizations to your PyTorch models directly with a single line of code.

\[GenAI Out Of The Box\](../openvino-workflow-generative/inference-with-genai.md)  
...
[Python / C++ / C / NodeJS APIs](https://docs.openvino.ai/2026/api/api_reference.html)  
...
\[Open source and easy to extend\](../about-openvino/contributing.md)  
...
\[Local or remote\](../openvino-workflow.md)  
    Integrate the OpenVINO runtime directly with your application to run inference locally or use [OpenVINO Model Server](https://github.com/openvinotoolkit/model_server) to shift the inference workload to a remote system, a separate server or a Kubernetes environment. For serving, OpenVINO is also integrated with [vLLM](https://docs.vllm.ai/en/stable/getting_started/openvino-installation.html) and [Triton](https://github.com/triton-inference-server/openvino_backend) services.

\[Scalable and portable\](release-notes-openvino/system-requirements.md)  
...
\[Model Optimization\](../openvino-workflow/model-optimization.md)  
...
\[Top performance\](../about-openvino/performance-benchmarks.md)  
...
\[Enhanced App Start-Up Time\](../openvino-workflow/running-inference/optimize-inference.md)  
