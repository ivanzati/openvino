...
**Attributes**:
  ...
  - *num*
      ...
      - **Required**: *yes*
  - *do\_softmax*
      - **Description**: *do\_softmax* is a flag that specifies the inference method and affects how the number of regions is determined. It also affects output shape. If it is 0, then output shape is 4D, and 2D otherwise.
      - **Range of values**:
      ...
      - **Required**: *no*
  - *mask*
      - **Description**: *mask* specifies the number of regions. Use this attribute instead of *num* when *do\_softmax* is equal to 0.
