...
> can be performed on a single input tensor to set a value to variable\_id.
...
\[State API\](../../../../../../openvino-workflow/running-inference/inference-request/stateful-models.md) documentation page.
