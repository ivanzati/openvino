...
**Outputs**
  ...
  - **1**: The result of element-wise *LogicalOr* operation. A tensor of type *T\_BOOL* and the same shape equal to broadcasted shape of two inputs.
