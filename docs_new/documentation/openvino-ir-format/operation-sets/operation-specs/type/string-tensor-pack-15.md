---
sidebar_label: 'StringTensorPack'
format: md
---
...
**Inputs**
  ...
  - **1**: `begins` - ND tensor of non-negative integer numbers of type *T\_IDX*, containing indices of each string's beginnings. **Required.**
  - **2**: `ends` - ND tensor of non-negative integer numbers of type *T\_IDX*, containing indices of each string's endings. **Required.**
