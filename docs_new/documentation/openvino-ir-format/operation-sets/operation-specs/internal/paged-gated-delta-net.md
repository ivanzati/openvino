---
sidebar_label: 'PagedGatedDeltaNet'
format: md
---
...
2.  prefill with past\_len % cache\_interval == 0. Read from block 0, write to block 1...N
3.  prefill with past\_len % cache\_interval \!=0. Read from block 0, write to block 1...N
4.  decode with past\_len % cache\_interval == 0. Read from block 0, write to block 1

5\. decode with past\_len % cache\_interval \!=0. Read from block 0, write to block 1
**Attributes**
...
**Inputs**
  ...
  - **6**: `subsequence_begins` - Tensor of type *T\_IND* and shape `[batch_size_in_sequences + 1]`.
  ...
  - **7**: `block_indices` - Tensor of type *T\_IND* and shape `[num_blocks]`.
  ...
  - **8**: `block_indices_begins` - Tensor of type *T\_IND* and shape
  ...
  - **9**: `past_lens` - Tensor of type *T\_IND* and shape `[batch_size_in_sequences]`.
    ...
    **Required.**
  - **10**: `cache_interval` - Tensor of type *T\_IND* and shape `[batch_size_in_sequences]`.
