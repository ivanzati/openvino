...
Similar to *I420toRGB* but output channels for each pixel are reversed so that the first channel is `blue`, the second one is `green`, the last one is `red`. See detailed conversion formulas in the \[I420toRGB description\](i420-to-rgb-8.md).

**Inputs:**

Same as specified for \[I420toRGB\](i420-to-rgb-8.md) operation.
