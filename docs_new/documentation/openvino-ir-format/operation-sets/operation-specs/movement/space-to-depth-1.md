...
**Attributes**
  ...
  - *mode*
      ...
      - **Range of values**:
          - *blocks\_first*: the output depth is gathered from `[block_size, ..., block_size,  C]`
          - *depth\_first*: the output depth is gathered from `[C, block_size, ..., block_size]`
      - **Type**: `string`
      - **Required**: *yes*
