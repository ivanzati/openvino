---
sidebar_label: 'Step 2. Markup Transformations'
format: md
---
...
1.  \[MarkupBias\](step2-markup/markup-bias.md)
2.  \[MarkupCanBeQuantized\](step2-markup/markup-can-be-quantized.md)
3.  \[MarkupPrecisions\](step2-markup/markup-precisions.md)
4.  \[MarkupPerTensorQuantization\](step2-markup/markup-per-tensor-quantization.md)
5.  \[MarkupAvgPoolPrecisionPreserved\](step2-markup/markup-avg-pool-precision-preserved.md)
6.  \[PropagatePrecisions\](step2-markup/propagate-precisions.md)
7.  \[PropagateSharedValue\](step2-markup/propagate-shared-value.md)
8.  \[AlignQuantizationIntervals\](step2-markup/align-quantization-intervals.md)
9.  \[AlignQuantizationParameters\](step2-markup/align-quantization-parameters.md)
...
Common markup transformations can be decomposed into simpler utility markup transformations. The order of Markup utility transformations is not important:
  ...
  - \[CreateAttribute\](step2-markup/create-attribute.md)
  - \[CreatePrecisionsDependentAttribute\](step2-markup/create-precisions-dependent-attribute.md)
  - \[PropagateThroughPrecisionPreserved\](step2-markup/propagate-through-precision-preserved.md)
  - \[PropagateToInput\](step2-markup/propagate-to-input.md)
  - \[UpdateSharedPrecisionPreserved\](step2-markup/update-shared-precision-preserved.md)

Let's explore all transformations and their relations in detail, using one and the same model:

![image](img/step2_markup_original.svg)
...
![MarkupCanBeQuantize](img/step2_markup1.svg)
...
![MarkupPrecisions result](img/step2_markup2.svg)
...
![MarkupPerTensorQuantization result](img/step2_markup3.svg)
...
![arkupAvgPoolPrecisionPreserved](img/step2_markup4.svg)
...
![PropagatePrecisions](img/step2_markup5.svg)
...
![AlignQuantizationIntervals](img/step2_markup6.svg)
...
![AlignQuantizationParameters](img/step2_markup7.svg)
