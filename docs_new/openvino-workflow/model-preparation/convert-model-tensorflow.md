---
sidebar_label: 'Converting a TensorFlow Model'
format: md
---
...
1.  **SavedModel format**. In this case, a model consists of a special directory with a
    ...
    [README](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/python/saved_model#components)
...
2.  **Checkpoint**. In this case, a model consists of two files: `inference_graph.pb`
    ...
    [Freezing Custom Models in Python](#freezing-custom-models-in-python) section.
