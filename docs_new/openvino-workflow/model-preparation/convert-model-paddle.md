---
sidebar_label: 'Converting a PaddlePaddle Model'
format: md
---
...
[Exporting PaddlePaddle Inference Model](https://www.paddlepaddle.org.cn/documentation/docs/zh/develop/guides/beginner/model_save_load_cn.html)
Chinese guide.

You can download a PaddlePaddle model from [Hugging Face](https://huggingface.co/models).
