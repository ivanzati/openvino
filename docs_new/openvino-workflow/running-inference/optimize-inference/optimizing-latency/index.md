---
sidebar_label: 'Optimizing for Latency'
format: md
---
...
needed, for example to support *asynchronous input population*.
...
in this area. Instead, you should specify \[performance hints\](high-level-performance-hints.md)
...
better for inference. In such cases, \[Model caching\](optimizing-latency/model-caching-overview.md)
...
ov::enable\_mmap() \<../../../api/ie\_python\_api/\_autosummary/openvino.frontend.FrontEnd.html\#openvino.frontend.FrontEnd.load>
property for the `ov::Core` as either `True` or `False`.

You can also use \[AUTO device selection inference mode\](../inference-devices-and-modes/auto-device-selection.md)
...
Keep in mind that any \[throughput-oriented options\](optimizing-throughput.md)
