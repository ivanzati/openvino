---
sidebar_label: 'When Dynamic Shapes API is Not Applicable'
format: md
---
...
Apply the following methods only if the \[native dynamic shape API\](../dynamic-shapes.md) does not work or does not perform as expected.
