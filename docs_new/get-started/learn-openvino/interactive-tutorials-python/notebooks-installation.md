---
sidebar_label: 'Install Notebooks'
format: md
---
...
<thead>
<tr class="header">
<th>Supported Operating System (64-bit)</th>
<th><a href="https://www.python.org/">Python Version (64-bit )</a></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<tr class="even">
<td>macOS 10.15.x versions or higher</td>
<td><blockquote>
<p>3.10, 3.11, 3.12, 3.13, 3.14</p>
</blockquote></td>
</tr>
<tr class="odd">
<td>Windows 10, 64-bit Pro, Enterprise</td>
<td><blockquote>
<p>3.10, 3.11, 3.12, 3.13, 3.14</p>
</blockquote></td>
</tr>
<tr class="even">
<td>Windows 10, 64-bit Pro, Enterprise or Education editions</td>
<td><blockquote>
<p>3.10, 3.11, 3.12</p>
</blockquote></td>
</tr>
<tr class="odd">
<td>Windows Server 2016 or higher</td>
<td><blockquote>
<p>3.10, 3.11, 3.12</p>
</blockquote></td>
</tr>
...
1.  **Install Python**
    ...
    Download 64 bit version of Python software (3.10 - 3.14) from [python.org](https://www.python.org/downloads/windows/)
...
2.  **Install GIT**
    ...
    [git-scm.org](https://github.com/git-for-windows/git/releases/download/v2.36.0.windows.1/Git-2.36.0-64-bit.exe)
...
3.  **Install Drivers for GPU, and NPU (AI PC)**
    ...
    [WHQL Certified GPU driver](https://www.intel.com/content/www/us/en/download/785597/834050/intel-arc-iris-xe-graphics-windows.html)
    ...
    (or last known working driver -[Windows 32.0.100.3053](https://www.intel.com/content/www/us/en/download/794734/835602/intel-npu-driver-windows.html)
...
1.  **Install Python and GIT**
    ...
    [here](https://github.com/openvinotoolkit/openvino_notebooks/discussions/540)
...
[Python 3](https://www.python.org/) and [Git](https://git-scm.com/).
...
An Azure account and access to [Azure ML Studio](https://ml.azure.com/)
are required.

1.  **Adding a Compute Instance**
    
    In Azure ML Studio,
    [add a compute instance](https://docs.microsoft.com/en-us/azure/machine-learning/how-to-create-manage-compute-instance?tabs=python)
    and pick any CPU-based instance. At least 4 CPU cores and 8GB of RAM
    are recommended.
    
    ![ml-studio-1](https://user-images.githubusercontent.com/15709723/117559437-17463180-b03a-11eb-9e8d-d4539d1502f2.png)
...
2.  **Start the Terminal**
    ...
    ![ml-studio-2](https://user-images.githubusercontent.com/15709723/117582205-b6f4d580-b0b5-11eb-9b83-eb2004ad9b19.png)
...
An [AWS](https://console.aws.amazon.com/console/home?nc2=h_ct&src=header-signin)
...
1.  **Log into your Amazon SageMaker Studio Environment and** `Add user`.
    ...
    ![amazon-studio-1](https://user-images.githubusercontent.com/4837253/199801883-7bb64ad2-bb7f-4477-ace1-25111d4fd43c.png)

2.  **Choose desired user profile name**
    
    ![amazon-studio-2](https://user-images.githubusercontent.com/4837253/199802173-8d65c851-604b-4b92-bafa-cae86b17d1ec.png)

3.  **Choose Jupyter Lab version 3.0**
    
    ![amazon-studio-3](https://user-images.githubusercontent.com/4837253/199802353-14c17233-3dae-4649-bbfe-59b8a598450c.png)
...
5.  **Launch the Amazon SageMaker Studio environment.**
    ...
    ![amazon-studio-4](https://user-images.githubusercontent.com/4837253/199802726-97c85732-ff25-4cdd-ad6e-d491b4ed122b.png)
...
6.  **Wait for a couple of minutes for your environment to load.**
    ...
    ![amazon-studio-5](https://user-images.githubusercontent.com/15709723/199784252-c8581c73-342a-4c70-9207-5543d7b87346.png)
...
7.  **Select a SageMaker image.**
    ...
    ![amazon-studio-6](https://user-images.githubusercontent.com/4837253/199805717-5d102d27-e92e-4426-8d14-0484fd5ba24c.png)
...
5.  **Install required packages**
    ...
    For more information, visit [HF-Mirror HuggingFace](https://hf-mirror.com).
...
5.  **Install required packages**
    ...
    .. important::
       ...
       For more information, visit `HF-Mirror HuggingFace [https://hf-mirror.com](https://hf-mirror.com)`__.
    ```
...
7.  Run the notebooks.
    ...
    1.  To run the notebooks, click on "Notebooks" and refresh your "Files":
...
3.  **Run the Docker Image**
    ...
    2.  Command for CPU and GPU (requires system with integrated or
        discrete Intel GPU):
...
4.  **Start the browser**
    ...
    ![docker-terminal-1](https://user-images.githubusercontent.com/15709723/127793994-355e4d29-d131-432d-a12a-b08ca6131223.png)
    ...
    The base layer is a
    [UBI 8](https://catalog.redhat.com/software/containers/ubi8/5c647760bed8bd28d0e38f9f?container-tabs=overview)
    \-based image provided by [Project Thoth](https://thoth-station.ninja/).
...
![amazon-studio-7](https://user-images.githubusercontent.com/4837253/199807022-3cc5dd9e-f9f0-445d-be5e-d429dc1b752c.png)
...
4.  **Run the Notebooks**
    ...
    1.  To run the notebooks, click the top level "openvino\_notebooks" folder
        and navigate to your example:
        
        ![amazon-studio-8](https://user-images.githubusercontent.com/4837253/199810405-0f6748e1-d5f5-469e-8305-a96724dfffba.png)
    
    2.  Choose "Image" - `Data Science 3.0`,
        "Kernel" - `Python [conda env:openvino_env],`
        "Instance type"- your desired compute instance.
        
        ![amazon-studio-9](https://user-images.githubusercontent.com/4837253/199812540-c52ea429-9d53-4bdb-aec1-a0b8616c6fcc.png)
        
        ![amazon-studio-10](https://user-images.githubusercontent.com/4837253/199812587-20c3e360-3a31-4032-b17a-8b242d6ccc26.png)
        
        ![amazon-studio-11](https://user-images.githubusercontent.com/4837253/199812713-32074aa7-8190-43c8-815c-231542c7b286.png)
    ...
    3.  Next, run the cells of the notebook. You may try other notebooks to
...
see the \[Run Notebooks\](run-notebooks.md) article.

## Troubleshooting

For solutions to common issues during installation, refer to the
[Troubleshooting](https://github.com/openvinotoolkit/openvino_notebooks#%EF%B8%8F-troubleshooting)
and
[FAQ](https://github.com/openvinotoolkit/openvino_notebooks#%EF%B8%8F-troubleshooting)
sections in [openvino\_notebooks](https://github.com/openvinotoolkit/openvino_notebooks)
repository.

If the above tips do not solve your problem, feel free to open a
[discussion topic](https://github.com/openvinotoolkit/openvino_notebooks/discussions)
or create an
[issue](https://github.com/openvinotoolkit/openvino_notebooks/issues) on Github.
